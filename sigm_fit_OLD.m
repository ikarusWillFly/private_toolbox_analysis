function [param,stat]=sigm_fit(x,y,fixed_params,initial_params,predX,plot_flag)
...
eval(f_str)
op = [];
% op.RobustWgtFun  = 'bisquare';
op.MaxIter       = 1000;
[BETA,RESID,J,COVB,MSE] = nlinfit(x,y,f,initial_params(bool_vec==1),op);
stat.param=BETA';
...
[stat.ypred,delta] = nlpredci(f,predX,BETA,RESID,'Covar',COVB);
